    ...
    extend: {
      ...
      colors: {
        ...
        dark: {
          ...
          card: "hsl(var(--dark-card) / <alpha-value>)",
          border: "hsl(var(--dark-border) / <alpha-value>)",
        },
        primary: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 8px hsl(40 60% 50% / 0.2)" },
          "50%": { boxShadow: "0 0 24px hsl(40 60% 50% / 0.5)" },
        },
        "slide-in-bottom": {
